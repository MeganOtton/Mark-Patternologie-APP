import { allTiledCanvases, isDrawing, drawingPath, allDrawings } from './drawingState.js';
import { drawGrid, gridDivisions } from './grid.js';
import { redrawCanvas} from './drawingCore.js';

export function tileDrawing(ctx:CanvasRenderingContext2D, canvas:HTMLCanvasElement, gridDivisions:number) {
